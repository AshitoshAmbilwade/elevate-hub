        ...
        <div className="grid gap-8 row-gap-10 md:grid-cols-2 lg:grid-cols-3">
          <div className="max-w-md text-center bg-white p-8 rounded-lg shadow-xl transition-transform transform hover:scale-105">
            ...
            <p className="text-sm text-gray-700 mb-4">
              ...
              support for resume building, job interviews, and navigating your
              professional growth.
            </p>
            <a
              href="/"
          ...
          <div className="max-w-md text-center bg-white p-8 rounded-lg shadow-xl transition-transform transform hover:scale-105">
            ...
            <p className="text-sm text-gray-700 mb-4">
              Our mentors design personalized learning plans that cater to your
              unique goals, helping you stay focused and motivated throughout
              your journey.
            </p>
            <a
              href="/"
          ...
          <div className="max-w-md text-center bg-white p-8 rounded-lg shadow-xl transition-transform transform hover:scale-105">
            ...
            <p className="text-sm text-gray-700 mb-4">
              ElevateHub ensures that mentorship is accessible to all. Choose
              flexible and affordable mentoring sessions that fit your budget
              and schedule.
            </p>
            <a
              href="/"
          ...
          <div className="max-w-md text-center bg-white p-8 rounded-lg shadow-xl transition-transform transform hover:scale-105">
            ...
            <p className="text-sm text-gray-700 mb-4">
              Mentorship opens doors to valuable networking opportunities. Build
              lasting relationships with mentors and professionals in your
              field.
            </p>
            <a
              href="/"
